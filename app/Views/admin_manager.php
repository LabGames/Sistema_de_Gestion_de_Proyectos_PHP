    ...
    <main> 
        <nav class="container">
            <ul>
                ...
                <li class="user">
                    <input class="name" type="text" name="member" value="Miembro 1" required readonly>
                    <img class="icon" src="<?= BASE_URL ?>/Assets/images/logo.png.webp" alt="Planeta" class="task-image" width="50" height="50">
                    <button type="submit" class="btn-style" name="delete">Eliminar</button>
                </li>
                <li class="user">
                    <input class="name" type="text" name="member" value="Miembro 2" required readonly>
                    <img class="icon" src="<?= BASE_URL ?>/Assets/images/logo.png.webp" alt="Planeta" class="task-image" width="50" height="50">
                    <button type="submit" class="btn-style">Eliminar</button>
                </li>
                <li class="user">
                    <input class="name" type="text" name="member" value="Miembro 3" required readonly>
                    <img class="icon" src="<?= BASE_URL ?>/Assets/images/logo.png.webp" alt="Planeta" class="task-image" width="50" height="50">
                    <button type="submit" class="btn-style" name="delete" name="delete">Eliminar</button>
                </li>
                <li class="user">
                    <input class="name" type="text" name="member" value="Miembro 4" required readonly>
                    <img class="icon" src="<?= BASE_URL ?>/Assets/images/logo.png.webp" alt="Planeta" class="task-image" width="50" height="50">
                    <button type="submit" class="btn-style" name="delete">Eliminar</button>
                </li>
                <li>
